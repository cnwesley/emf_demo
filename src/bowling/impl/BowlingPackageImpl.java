...
public class BowlingPackageImpl extends EPackageImpl implements BowlingPackage {
	 ...
	 * @generated
	 */
	public EReference getLeague_Player() {
	...
	public void createPackageContents() {
		...
		createEReference(leagueEClass, LEAGUE__PLAYER);
	...
	public void initializePackageContents() {
		...
		initEReference(getPlayer_Games(), this.getGame(), null, "games", null, 0, -1, Player.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getLeague_Player(), this.getPlayer(), null, "player", null, 0, -1, League.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

...
public interface BowlingPackage extends EPackage {
	...
	/**
	 * Returns the meta object for the containment reference list '{@link bowling.League#getPlayer <em>Player</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Player</em>'.
	 * @see bowling.League#getPlayer()
	 * @see #getLeague()
	 * @generated
	 */
	EReference getLeague_Player();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference LEAGUE__PLAYER = eINSTANCE.getLeague_Player();
